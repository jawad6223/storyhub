            ...
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-header align-items-center d-flex">
                     <h2 class="card-title mb-0 flex-grow-1" style="font-weight:700"> Edit Story</h2>
                  </div>
                  <!-- end card header -->
                  <div class="card-body">
                     <div class="live-preview">
                     <form  action="{{url('admin/edit_story_action')}}" method="post" enctype="multipart/form-data">
                                                @csrf
                     <input type="hidden" name="id" value="{{$story->id}}"  >
                        ...
                        <div class="row gy-4 mt-1">
                           <div class=" col-md-4">
                              <div>
                                 ...
                                 <input type="text" name="title" value="{{$story->title}}" required class="form-control border-dashed" id="borderInput" placeholder="Enter your name">
                              </div>
                           </div>
                           <div class=" col-md-4">
                              <div>
                                 ...
                                 <select class="form-select mb-3 border-dashed" aria-label="Default select example" required name="category">
                                    ...
                                    @foreach($cat as $cat) 
                                    <option value="{{$cat->id}}" {{ $cat->id == $story->category_id ? 'selected' : '' }}>{{$cat->name}}</option>
                                    @endforeach
                           ...
                           <div class=" col-md-4">
                              <div>
                                 ...
                                 <select class="form-select mb-3 border-dashed" aria-label="Default select example" required name="linked_by">
                       
                                    @foreach($story1 as $story1) 
                                    <option value="{{$story1->id}}" {{ $story1->id == $story->linked_by ? 'selected' : '' }}>{{$story1->title}}</option>
                                    @endforeach
                        ...
                        <div class="row gy-4 ">
                           <div class=" col-md-12">
                            ...
                            <textarea name="description" id="myTextarea"> {{$story->description}}</textarea>
                           ...
                           <div class=" col-md-12">
                            ...
                            <textarea name="criteria" id="myTextarea1"  > {{$story->criteria}}</textarea>
