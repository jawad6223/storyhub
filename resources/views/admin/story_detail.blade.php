                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="d-flex">
                                    ...
                                    <div style="margin-left:auto">
                                        <a href="{{url('admin/edit_story/'.$story->id)}}" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Story</a>
                                    </div>
                                    &nbsp; 
                                    <div class="flex-shrink-0">
                                        <a href="{{url('admin/story_delete/'.$story->id)}}" class="btn btn-danger"><i class="ri-delete-bin-fill align-bottom"></i> Delete Story</a>
                                    </div>
                                </div>
                                <!-- Tab panes -->
...
<h6>Acceptance Criteria</h6>
                                       ...
                                       <a href="{{url('admin/story_hub/'.$story->linked_by)}}" class="link-success float-end"><i class=" ri-links-line align-middle ms-1 lh-1"></i> View Reference story </a>
