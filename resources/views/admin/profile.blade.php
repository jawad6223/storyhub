               ...
               <div class="col-lg-12">
                  <div>
                     <div class="d-flex">
                        ...
                        <a href="{{url('admin/add_story')}}" class="btn btn-success" ><i class="ri-file-history-fill align-bottom"></i> Share New Story</a>
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="col-lg-4">
                                                      <div class="mb-3">
                                                         ...
                                                         <input type="text" class="form-control"  name="user_name" placeholder="Enter your Username" value="{{$user->user_name}}">
                                                      </div>
                                                   </div>
                                                   <!--end col-->
                                                   <!--end col-->
                                                   ...
                                                   <div class="col-lg-4">
                                                      <div class="mb-3">
                                                         ...
                                                         <input type="text" class="form-control"  placeholder="Enter your phone number" name="contact" value="{{$user->contact}}">
                                                      </div>
                                                   </div>
                                                   <!--end col-->
                                                   <div class="col-lg-4">
                                                   ...
                                                   <div class="col-lg-4">
                                                      <div class="mb-3">
                                                         ...
                                                         <input type="url" class="form-control" name="website"  placeholder="Enter your Website Url" value="{{$user->website}}">
                                                      </div>
                                                   </div>
                                                   <!--end col-->
                                                   <div class="col-lg-4">
                                                      <div class="mb-3">
                                                         ...
                                                         <input type="url" class="form-control" name="twitter" placeholder="Enter your Twitter Url" value="{{$user->twitter}}">
                                                      </div>
                                                   </div>
                                                   <!--end col-->
                                                   <div class="col-lg-4">
                                                      <div class="mb-3">
                                                         ...
                                                         <input type="url" class="form-control" name="facebook"  placeholder="Enter your Fackbook Url" value="{{$user->facebook}}">
                                                      </div>
                                                   </div>
                                                   <div class="col-lg-4">
                                                      <div class="mb-3">
                                                         <label for="emailInput" class="form-label">Linkedin</label>
                                                         <input type="url" class="form-control" name="linkedin" placeholder="Enter your Linkedin" value="{{$user->linkedin}}">
                                                      </div>
                                                   </div>
                                                   <div class="col-lg-12">
                                                      <div class="mb-3 pb-2">
                        ...
                        <div class="card card-body">
                           <div class="d-flex mb-4 align-items-center">
                              ...
                              <div class="" style="float:right"  >
                                 <a href="{{url('admin/edit_story/'.$story->id)}}"> <i class="ri-edit-2-fill" style="color:green; font-size:20px"></i>  </a>
                                 <a href="{{url('admin/story_delete/'.$story->id)}}"><i class="ri-delete-bin-fill" style="color:red; font-size:18px"></i></a>  
                              </div>
                           </div>
                           ...
                           @if(!empty($story->linked_by))
                                       <a href="{{url('admin/story_detail/'.$story->linked_by)}}" class="link-success "><i class=" ri-links-line align-middle ms-1 lh-1"></i> View Reference story </a>
                                         @endif
                                          <a href="{{url('admin/story_detail/'.$story->id)}}" class="link-success float-end">Read More <i class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></a>
