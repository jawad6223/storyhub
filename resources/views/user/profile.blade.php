                     ...
                     <div class="col-lg-12">
                        <div class="card card-body">
                           ...
                           @if(!empty($story->linked_by))
                                       <a href="{{url('user/story_detail/'.$story->linked_by)}}" class="link-success "><i class=" ri-links-line align-middle ms-1 lh-1"></i> View Reference story </a>
                                         @endif
                                          <a href="{{url('user/story_detail/'.$story->id)}}" class="link-success float-end">Read More <i class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></a>
