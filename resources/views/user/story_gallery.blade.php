...
@include('user.includes.head')</head>
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="page-content">
                <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Story Gallery</h4>
                                </div><!-- end card header -->
                  ...
                  <div id="dropzone">
        <form action="{{ route('dropzoneFileUpload2') }}" class="dropzone"  id="file-upload2" enctype="multipart/form-data">
            @csrf
            ...
            <i class='sl sl-icon-cloud-upload'></i>  Drag and Drop Single/Multiple Files Here<br>
              ...
              <div class="row mt-3  ">
                              ...
                              <a href="{{url('user/profile')}}" class="btn btn-primary lg " style="float:right;  margin-left:20px;" >
                                 View Story </a>   
                                
                                 <a href="{{url('user/profile')}}" class="btn btn-primary lg " style="float:right;" >
                                 Post Gallery </a> 
                              </div>
                           </div>
