    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="page-content">
                <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="row mb-5">
                                                       ...
                                                       <div class="col-sm-3">
                                                       <a href="{{url('user/delete_story_gallery_img/'.$img->id)}}"><i class="ri-delete-bin-fill" style="color:red; font-size:18px;float:right"></i></a>  
                  ...
                  <div id="dropzone">
        <form action="{{ route('dropzoneFileUpload3') }}" class="dropzone"  id="file-upload3" enctype="multipart/form-data">
            @csrf
            ...
            <i class='sl sl-icon-cloud-upload'></i>  Drag and Drop Single/Multiple Files Here<br>
              ...
              <div class="row mt-3  ">
                              <div class=" col-md-12">
                                 ...
                                 <a href="{{url('user/view_story')}}" class="btn btn-primary lg " style="float:right" >
                                 Post Story </a> 
                              </div>
                           </div>
